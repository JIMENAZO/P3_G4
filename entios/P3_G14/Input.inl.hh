...
namespace enti
{
	...
	{
		NONE = -1, w = 87, W = 119, a = 65, A = 97, s = 83, S = 115, d = 68, D = 100, x = 120, X = 88, z = 122, Z = 90, 
	...
	inline InputKey systemPause() // Pauses the execution until a key is pressed
	{
		InputKey aux; 
		do {
			aux = getInputKey();
		} while (aux == InputKey::NONE);
